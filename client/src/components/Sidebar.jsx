...
const Sidebar = ({sidebar, setSidebar}) => {
  ...
  return (
    <div className={`w-50 overflow-y-scroll sm:w-60 border-r border-gray-200 flex flex-col justify-between items-center max-sm:absolute top-16 bottom-0 ${sidebar? 'translate-x-0': 'max-sm:-translate-x-full'} transition-transform duration-300 ease-in-out bg-white`}>
