...
function CreationItem({item}) {
  ...
  return (
    <div onClick={() => setExpanded(!expanded)} className='p-4 max-w-5xl border border-gray-300 rounded-lg bg-white text-sm cursor-pointer'>
            ...
            <div>
                {
                    item.type === 'image'? (
                        ...
                        <div className='h-full overflow-y-scroll mt-3 text-sm text-slate-700'>
