...
function Footer() {
  ...
  return (
   <div>
         <div className='grid sm:grid-cols-5 md:grid-cols-9 gap-4 mx-10 md:mx-15 py-5 border-b border-gray-300'>
        ...
        <div className='sm:col-span-6 md:col-span-4 lg:col-span-3 sm:text-center'>
            ...
            <div className='flex md:justify-start sm:justify-center'>
                <input type="email" className='text-gray-500 rounded-md border border-gray-300 p-1 mr-1 w-xs text-md' placeholder='Enter your email' />
